...
def align(spk_to_utt1, spk_to_utt2, spk_to_utt3, spk_to_utt4, spk_to_utt5, grade_dict1, grade_dict2, grade_dict3, grade_dict4, grade_dict5, grade_dict_overall, grade_lim):
    grades1 = []
    grades2 = []
    grades3 = []
    grades4 = []
    ...
    for id in spk_to_utt1:
        try:
            if grade_dict_overall[id]>=grade_lim:
...
def get_data(data_dir, grades_file, grade_lim):
    '''
    Returns all data aligned filtered by overall grade
    '''
    utt_dicts = []
    grade_dicts = []
    ...
    all_utts, all_grades = align(utt_dicts[0], utt_dicts[1], utt_dicts[2], utt_dicts[3], utt_dicts[4], grade_dicts[0], grade_dicts[1], grade_dicts[2], grade_dicts[3], grade_dicts[4], overall_grade_dict, grade_lim)
