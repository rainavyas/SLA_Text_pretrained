...
if __name__ == "__main__":
    ...
    commandLineParser.add_argument('--filter', type=str, default='True', help="Specify if 4.0 filtered models to be loaded from dir")
    ...
    if not os.path.isdir('CMDs'):
        os.mkdir('CMDs')
    with open('CMDs/eval_all_parts_filter.cmd', 'a') as f:
        f.write(' '.join(sys.argv)+'\n')

    # Load all parts data aligned
    part_data_list, labels = get_data(test_data_dir, test_grades_files, grade_lim)
